      ...
      max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm
            <span className="text-[#915eff]"> Olalere</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop web applications,<br className="sm:block hidde
      ...
      <div className="absolute xs:bottom-10 bottom-32
        ...
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl
            border-4 border-secondary flex justify-center items-start p-1 -mb-12">
            <motion.div
              animate={{ y: [0, 24, 0] }}
              transition={{
                duration: 1.5,
